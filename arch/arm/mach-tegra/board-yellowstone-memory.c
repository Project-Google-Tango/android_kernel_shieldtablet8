...
static struct tegra12_emc_table yellowstone_lpddr3_emc_table[] = {
	{
		0x19,       /* V5.0.14 */
...
static struct tegra12_emc_pdata yellowstone_lpddr3_emc_pdata = {
	.description = "ardbeg_emc_tables",
	.tables = yellowstone_lpddr3_emc_table,
